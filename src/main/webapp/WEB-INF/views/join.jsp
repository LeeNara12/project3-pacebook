    ...
    <div class="login">
        ...
        <form name="join">
            <div class="text_boxes">
                <div class="box">
                    <div><b>아이디</b></div>
                    <input type="text" id="id" name="user_id" class="book" id="ID" required>
                    <div id="id_" class="hidden_msg"></div>
                </div>
                <br>
                <div class="box">
                    <div><b>비밀번호</b></div>
                    <input type="password" id="pw" name="user_pw" class="book" title="pw" required>
                ...
                <div class="box">
                    <div><b>이름</b></div>
                    <input type="text" id="name" name="user_name" class="book" title="name" required>
                    <div id="name_" class="hidden_msg">이름을 입력해주세요</div>
                </div>
                <br>
                <div class="box">
                    <div><b>이메일</b></div>
                    <input type="text" id="email" name="user_email" class="book" title="email" required>
                    <div id="email_" class="hidden_msg">이메일을 입력해주세요</div>
                </div>
                <br>
                <div class="box">
                    <div><b>전화번호</b></div>
                    <input type="text" id="phone" name="user_phone" class="book" title="number" oninput="autoHyphen(this)"
                ...
                <div class="box">
                    <div><b>생년월일</b></div>
                    <input type="date" id="birth" name="user_birth" class="book" title="date">
                    <div id="birth_" class="hidden_msg">생년월일을 입력해주세요</div>
                </div>
                <br>
                <div class="box">
                    <div><b>성별</b></div>
                    <input id="radio1" type="radio" name="user_gender" value="male" checked><label for="radio1">
                    ...
                    <input id="radio2" type="radio" name="user_gender" value="female"><label for="radio2">
        ...
        <div id="login_btn">
            <a href="/pacebook" style="text-decoration-line:none; color: rgb(107, 105, 105);"  >로그인페이지로 이동</a>
        </div>
    </div>
</div>
    <script>
